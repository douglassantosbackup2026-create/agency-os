...
export const landingPrimaryCtaClass =
  "glow-primary inline-flex min-h-11 items-center justify-center rounded-lg bg-primary px-6 py-2.5 text-center text-sm font-semibold text-primary-foreground shadow-sm transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-55";
...
export const landingSurfaceCardClass =
  "surface-card rounded-2xl border border-border shadow-sm ring-1 ring-border/60";
