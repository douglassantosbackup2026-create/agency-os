          ...
          <Card>
            ...
            <div className="space-y-4 p-4 text-sm">
              <p className="text-muted-foreground">
                ...
                <strong>Secrets das Edge Functions</strong> do projeto Supabase
                (não na base). Cada agência liga as suas contas em{" "}
                <Link
                  to="/integrations"
              ...
              {data?.oauthFnError ? (
                ...
                <ul className="space-y-2 rounded-md border border-border bg-muted/20 p-3">
                  ...
                  <li className="flex items-center gap-2">
                    <StatusDot
                      ok={data.oauthStatus.tiktok_client_or_app_id_ok}
                    />
