      ...
      <div className="grid gap-4 lg:grid-cols-2">
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <input
                  value={color}
                  onChange={(e) => setColor(e.target.value)}
                  className="h-9 flex-1 rounded-md border border-border bg-background px-3 font-mono text-sm"
                />
              </div>
            </div>
            <Field
        ...
        <Card className="lg:col-span-2">
          ...
          <div className="flex items-center justify-between p-4">
            <p className="text-sm text-muted-foreground">
              Cria 8 clientes fictícios com 30 dias de métricas, alertas e
              atividades.
            </p>
            <button
              onClick={seed}
            ...
            >
              ...
              {seeding ? "Gerando..." : "Gerar dados demo"}
            </button>
          </div>
        </Card>
      </div>
