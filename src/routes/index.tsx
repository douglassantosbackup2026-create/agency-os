...
const SECTION_SCROLL = "scroll-mt-[calc(4.75rem+env(safe-area-inset-top,0px))]";
              ...
              <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14 xl:gap-16">
                <div className="text-center lg:text-left">
                  ...
                  <div className="mt-9 flex w-full max-w-md flex-col gap-3 sm:max-w-none sm:flex-row sm:flex-wrap lg:mx-0">
                    <Link
                      to="/demo"
                      className="glow-primary inline-flex min-h-11 flex-1 items-center justify-center rounded-lg bg-primary px-6 py-2.5 text-center text-sm font-semibold text-primary-foreground shadow-sm transition hover:opacity-90 sm:flex-none sm:px-5"
                    >
                      {hero.ctaPrimary}
                    </Link>
                    <a
