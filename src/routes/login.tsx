...
function Login() {
  ...
  return (
    <AuthShell title="Entrar no Retentio" subtitle="Acesse o painel da sua agência">
...
export function Field({ label, type = "text", value, onChange, autoFocus }: { label: string; type?: string; value: string; onChange: (v: string) => void; autoFocus?: boolean }) {
  return (
